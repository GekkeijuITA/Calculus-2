    ...
    \subsection{Punti critici di $f$}
        ...
        \subsubsection{Classificazione}
            \begin{enumerate}
                ...
                \item Per ogni punto critico $(x_0,y_0)$ calcolo $D(x_0,y_0)$ \begin{itemize}
                    \item $D(x_0,y_0)>0$ \begin{itemize}
                        \item $f_{xx}(x_0,y_0)>0$: Il punto è un minimo locale
                        \item $f_{xx}(x_0,y_0)<0$: Il punto è un massimo locale
                    \end{itemize}
                    \item $D(x_0,y_0)<0$: punto di sella
                    \item $D(x_0,y_0)=0$: test inconcludente
                \end{itemize}
            \end{enumerate}
    \subsection{Esercizio da esame}
